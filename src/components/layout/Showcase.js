          ...
          <div className="container post-container">
              ...
              <div className="post-content">
                ...
                <h2>
                  <Link
                    ...
                    className="link"
                  >
                    🔥🔥 Full HTML Course For Absolute Beginners Without Paying
                    a single dollar!
                  </Link>
                </h2>
                <p>
                  Free yet Amazing HTML 5 Course For absolute Beginners Anyone
                  can join and learn HTML Without Giving A single Doller!
                </p>
            ...
            <div className="post">
              <div className="post-content">
                ...
                <p>
                  Creating a real server is very complex thing but creating a
                  web server is very easy thing in 2021 cuz we have some
                  framework like express and soo many other..
                </p>
            ...
            <div className="post">
              <div className="post-content">
                ...
                <p>
                  Now we can create a simple dark to light theme and light to
                  dark theme toggler in our website using few lines of code in
                  javasript.
                </p>
